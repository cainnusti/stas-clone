...
class Utility {
    constructor() {
      this.SATS = Number(process.env.SATS); // Don't change this setting unless you know what you're doing
      this.PERBYTE = Number(process.env.PERBYTE); // Don't change this setting unless you know what you're doing
